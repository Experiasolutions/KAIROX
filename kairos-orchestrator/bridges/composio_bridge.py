...
def _init_composio() -> bool:
    ...
    try:
        try:
            ...
            from composio import ComposioToolSet  # type: ignore[no-redef]
...
def get_tools_for_app(app_name: str) -> list[dict[str, str]]:
    ...
    try:
        try:
            from composio.tools import App
        except ImportError:
            from composio import App  # type: ignore[no-redef]
...
def execute_action(
    ...
    try:
        try:
            ...
            from composio import Action  # type: ignore[no-redef]
