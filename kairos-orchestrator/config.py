...
# ─── Modelo padrão ────────────────────────────────────────
DEFAULT_MODEL = "hf:meta-llama/Meta-Llama-3-8B-Instruct"

# ─── Roteamento de modelos ────────────────────────────────
ROUTING_RULES = {
    "morning_brief": "hf:meta-llama/Meta-Llama-3-8B-Instruct",
    "night_processing": "hf:meta-llama/Meta-Llama-3-8B-Instruct",
    "lead_analysis": "hf:meta-llama/Meta-Llama-3-8B-Instruct",
    "content_draft": "hf:meta-llama/Meta-Llama-3-8B-Instruct",
    "code_simple": "hf:meta-llama/Meta-Llama-3-8B-Instruct",
    "code_complex": "gemini-2.5-pro", # Keep Gemini for complex code
    "research": "hf:meta-llama/Meta-Llama-3-8B-Instruct",
